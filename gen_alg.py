...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.mutationMethodCombo.setItemText(1, _translate("Dialog", EMutation.INDEX_CHANGE.name))
        self.mutationMethodCombo.setItemText(2, _translate("Dialog", EMutation.GAUSS.name))
